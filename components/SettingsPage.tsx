        ...
        {activeSubTab === 'general' && (
          <div className="space-y-8">
            ...
            <div className="flex justify-end pt-8 border-t border-zinc-800">
               <button onClick={handleSaveGeneral} className="flex items-center gap-3 px-10 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl text-sm font-black uppercase tracking-widest shadow-lg shadow-blue-600/20 hover:shadow-blue-500/40 active:scale-95 transition-all">
        ...
        {activeSubTab === 'users' && (
           <div className="space-y-8 animate-in slide-in-from-bottom-2 duration-400">
              <div className="flex justify-between items-center">
                 ...
                 <button onClick={() => { setIsUserFormOpen(true); setEditingUserId(null); setUserFormData({ username: '', email: '', password: '', role: 'L1' }); }} className="flex items-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-lg shadow-blue-600/20 hover:shadow-blue-500/40 active:scale-95 transition-all"><Plus className="w-4 h-4" /> {t('provision_analyst')}</button>
              </div>
